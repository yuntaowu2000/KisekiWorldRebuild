...
public class AIDialog : MonoBehaviour, IAction
{
    ...
    [SerializeField] Dialog m_Dialog = null;
    private DialogNode m_CurrentNode = null;
    ...
    void LateUpdate()
    {
        if (!m_WorldCanvas.isActiveAndEnabled)
        {
            return;
        }
    ...
    private void StartDialog()
    {
        ...
        m_CurrentNode = m_Dialog.GetRootNode();
        UpdateUI();
    ...
    private void UpdateUI()
    {
        if (m_CurrentNode != null)
        {
            ...
            m_CurrentNode = m_Dialog.GetNode(m_CurrentNode.GetChild());
        }
        else
        {
